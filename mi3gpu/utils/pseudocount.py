...
def main():
    ...
    parser.add_argument(
        "--mode",
        default="jeffreys",
        choices=["jeffreys", "bayes", "meanfield", "unijmix", "constant", "tst"],
    )
    ...
    if args.mode == "constant":
        ...
        if len(pc) != 2:
            raise ValueError(
                "pc should be two values representing (pc, w)"
